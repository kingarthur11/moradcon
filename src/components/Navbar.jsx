...
const Navbar = () => {
    return (
      <div>      
        <nav class="bg-white border-b border-gray-200 dark:bg-gray-900 dark:border-gray-700 pb-4 mb-[50px]">
            <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto">
                <div>
                    <h4 className="font-bold">Hi, Arthur</h4>
                    <p className="font-medium">HRM Manager</p>
                </div>
