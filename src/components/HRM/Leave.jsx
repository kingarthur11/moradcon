            ...
            <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
                <div className='flex gap-4'>
                    ...
                    <select id="default" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                        ...
                        <option value="US">Request</option>
                        <option value="CA">Pending</option>
                        <option value="FR">Approved</option>
                    ...
                    <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                        ...
                        <tbody>
                            <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                                ...
                                <td class="px-6 py-4">
                                    <div className='font-bold bg-blue-400 p-2 text-white rounded'>Pending</div>                                
                                </td>
                                <td class="px-6 py-4">
                                2024-10-31
                                </td>
                                <td class="px-6 py-4">
                                123 Elm St, Springfield Abuja
                                </td>
                                <td class="px-6 py-4">
                                arthur_orduh_resume.pdf
                                </td>
                            ...
                            <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                                ...
                                <td class="px-6 py-4">
                                    <div className='font-bold bg-green-400 p-2 text-white rounded'>Approved</div>                                
                                </td>
                                <td class="px-6 py-4">
                                2024-10-31
                                </td>
                            ...
                            <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                                ...
                                <td class="px-6 py-4">
                                    <div className='font-bold bg-red-400 p-2 text-white rounded'>Rejected</div>                                
                                </td>
                                <td class="px-6 py-4">
                                2024-10-31
                                </td>
